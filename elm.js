...
var $evancz$elm_playground$Playground$fade = F2(
	function (o, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		var a = _v0.c;
		var s = _v0.d;
		var f = _v0.f;
		return A6($evancz$elm_playground$Playground$Shape, x, y, a, s, o, f);
	});
...
var $author$project$Illustration$size = function () {
	var half = 100;
	return {
		diagonal: $elm$core$Basics$sqrt(
			A2($elm$core$Basics$pow, half, 2) * 2),
		forth: half / 2,
		half: half,
		margin: 5
	};
...
var $author$project$Illustration$shape = function (color) {
	return {
		polygon: A2(
			...
			_List_fromArray(
				[
					_Utils_Tuple2(0, 0),
					_Utils_Tuple2($author$project$Illustration$size.half, 0),
					_Utils_Tuple2($author$project$Illustration$size.forth, $author$project$Illustration$size.forth),
					_Utils_Tuple2(-$author$project$Illustration$size.forth, $author$project$Illustration$size.forth)
				])),
		polygonMirror: A2(
			$evancz$elm_playground$Playground$polygon,
		...
		square: A2($evancz$elm_playground$Playground$square, color, $author$project$Illustration$size.diagonal / 2),
		triangleLarge: A2(
			$evancz$elm_playground$Playground$polygon,
			color,
			_List_fromArray(
				[
					_Utils_Tuple2(0, 0),
					_Utils_Tuple2(0, $author$project$Illustration$size.diagonal),
					_Utils_Tuple2($author$project$Illustration$size.diagonal, 0)
				])),
		triangleMedium: A2(
			$evancz$elm_playground$Playground$polygon,
			color,
			_List_fromArray(
				[
					_Utils_Tuple2(0, 0),
					_Utils_Tuple2(0, $author$project$Illustration$size.half),
					_Utils_Tuple2($author$project$Illustration$size.half, 0)
				])),
		triangleMediumSpecialForMargin: A2(
			$evancz$elm_playground$Playground$polygon,
			color,
			_List_fromArray(
				[
					_Utils_Tuple2(0, 0),
					_Utils_Tuple2(0, $author$project$Illustration$size.half + $author$project$Illustration$size.margin),
					_Utils_Tuple2($author$project$Illustration$size.half + $author$project$Illustration$size.margin, 0)
				])),
		triangleSmall: A2(
			$evancz$elm_playground$Playground$polygon,
			color,
			_List_fromArray(
				[
					_Utils_Tuple2(0, 0),
					_Utils_Tuple2(0, $author$project$Illustration$size.diagonal / 2),
					_Utils_Tuple2($author$project$Illustration$size.diagonal / 2, 0)
				]))
	};
};
var $author$project$Illustration$fish3 = function (palette) {
	return _List_fromArray(
		[
			...
			function ($) {
				...
				$author$project$Illustration$shape(palette.c1))),
			A3(
			...
			A2(
				...
				function ($) {
					...
					$author$project$Illustration$shape(palette.c2)))),
			A3(
			$evancz$elm_playground$Playground$move,
			-91,
			4,
			A3(
				$evancz$elm_playground$Playground$move,
				$author$project$Illustration$size.forth,
				0,
				function ($) {
					return $.square;
				}(
					$author$project$Illustration$shape(palette.c3)))),
			A3(
			$evancz$elm_playground$Playground$move,
			-82,
			46,
			A2(
				...
				function ($) {
					...
					$author$project$Illustration$shape(palette.c4)))),
			A3(
			$evancz$elm_playground$Playground$move,
			-5.5,
			46,
			A2(
				...
				function ($) {
					...
					$author$project$Illustration$shape(palette.c5)))),
			A3(
			$evancz$elm_playground$Playground$move,
			-6,
			-37,
			A2(
				...
				function ($) {
					...
					$author$project$Illustration$shape(palette.c6)))),
			A3(
			$evancz$elm_playground$Playground$move,
			-82,
			-33,
			A2(
				...
				45,
				function ($) {
					return $.polygonMirror;
				}(
					$author$project$Illustration$shape(palette.c7))))
		]);
};
...
var $author$project$Illustration$fishSmall3 = function (palette) {
	return A2(
		$evancz$elm_playground$Playground$rotate,
		120,
		A2(
			...
			A3(
				...
				$evancz$elm_playground$Playground$group(
					$author$project$Illustration$fish3(palette)))));
};
...
var $author$project$Illustration$baseColor = {
	gray1: A3($evancz$elm_playground$Playground$rgb, 205, 205, 200),
	gray2: A3($evancz$elm_playground$Playground$rgb, 230, 230, 230),
	gray3: A3($evancz$elm_playground$Playground$rgb, 180, 165, 180),
	yellow1: A3($evancz$elm_playground$Playground$rgb, 255, 250, 10),
	yellow2: A3($evancz$elm_playground$Playground$rgb, 255, 230, 10),
	yellow3: A3($evancz$elm_playground$Playground$rgb, 255, 210, 10)
};
var $author$project$Illustration$palette1 = {c1: $author$project$Illustration$baseColor.gray1, c2: $author$project$Illustration$baseColor.gray2, c3: $author$project$Illustration$baseColor.gray3, c4: $author$project$Illustration$baseColor.gray1, c5: $author$project$Illustration$baseColor.gray2, c6: $author$project$Illustration$baseColor.gray3, c7: $author$project$Illustration$baseColor.gray1};
...
var $author$project$Illustration$shoal = F2(
	function (qty, f) {
				...
				F2(
					function (y, _v0) {
						return A2(
							...
							A2($elm$core$List$repeat, qty, _Utils_Tuple0));
					}),
				A2($elm$core$List$repeat, qty, _Utils_Tuple0)));
	});
var $elm$core$Basics$toFloat = _Basics_toFloat;
var $author$project$Illustration$fishes = $evancz$elm_playground$Playground$group(
	A2(
		$author$project$Illustration$shoal,
		5,
		F2(
			function (x, y) {
				return A3(
					...
					70 * x,
					70 * y,
					((x === 3) && (y === 2)) ? $evancz$elm_playground$Playground$group(_List_Nil) : $author$project$Illustration$fishSmall3($author$project$Illustration$palette1));
			})));
var $author$project$Illustration$palette2 = {c1: $author$project$Illustration$baseColor.yellow1, c2: $author$project$Illustration$baseColor.yellow2, c3: $author$project$Illustration$baseColor.yellow3, c4: $author$project$Illustration$baseColor.yellow1, c5: $author$project$Illustration$baseColor.yellow2, c6: $author$project$Illustration$baseColor.yellow1, c7: $author$project$Illustration$baseColor.yellow3};
...
var $evancz$elm_playground$Playground$picture = function (shapes) {
	var view = function (screen) {
		return {
			body: _List_fromArray(
				[
					A2($evancz$elm_playground$Playground$render, screen, shapes)
				]),
			title: 'Playground'
		};
	};
	var update = F2(
		function (_v2, _v3) {
			...
			var height = _v2.b;
			return _Utils_Tuple2(
				A2($evancz$elm_playground$Playground$toScreen, width, height),
				$elm$core$Platform$Cmd$none);
		});
	var subscriptions = function (_v1) {
		return $elm$browser$Browser$Events$onResize($elm$core$Tuple$pair);
	};
	var init = function (_v0) {
		return _Utils_Tuple2(
			A2($evancz$elm_playground$Playground$toScreen, 600, 600),
			$elm$core$Platform$Cmd$none);
	};
...
var $author$project$Illustration$ripple = A2(
	$evancz$elm_playground$Playground$polygon,
	$evancz$elm_playground$Playground$white,
	_List_fromArray(
		[
			_Utils_Tuple2(0, 0),
			_Utils_Tuple2(6, 6),
...
var $author$project$Illustration$main = $evancz$elm_playground$Playground$picture(
	_List_fromArray(
		[
			A2($evancz$elm_playground$Playground$square, $evancz$elm_playground$Playground$blue, 2000),
			A2(
			$evancz$elm_playground$Playground$fade,
			0.7,
			A3(
				$evancz$elm_playground$Playground$move,
				-200,
				-200,
				A2($evancz$elm_playground$Playground$rotate, 45, $author$project$Illustration$fishes))),
			A2(
			$evancz$elm_playground$Playground$scale,
			1.4,
			A2(
				...
				A3(
					...
					20,
					180,
					$author$project$Illustration$fishSmall3($author$project$Illustration$palette2)))),
			A3(
			$evancz$elm_playground$Playground$move,
			-160,
			70,
			A2(
				...
				A2(
					$evancz$elm_playground$Playground$rotate,
					45,
					A2($evancz$elm_playground$Playground$scale, 4, $author$project$Illustration$ripple)))),
			A3(
			$evancz$elm_playground$Playground$move,
			-150,
			80,
			A2(
				...
				A2(
					$evancz$elm_playground$Playground$rotate,
					40,
					A2($evancz$elm_playground$Playground$scale, 2, $author$project$Illustration$ripple))))
		]));
_Platform_export({'Illustration':{'init':$author$project$Illustration$main(
