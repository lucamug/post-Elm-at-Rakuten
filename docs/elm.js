...
var $author$project$Post$snippets = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			...
			{code: '{{< highlight javascript >}}function add(a) {\n    return function(b) {\n        return a + b;\n    }\n}{{< /highlight >}}', gist: 'd67d7a3a424031ee88410f2e27dae2a0'}),
			_Utils_Tuple2(
			'{snippet_TypeSignatures.elm}',
			{code: '{{< highlight elm >}}div : List (Attribute msg) -> List (Html msg) -> Html msg\n\ntext : String -> Html msg{{< /highlight >}}', gist: '897f996bd5dc6466bdcef29e74c5e1a2'}),
			_Utils_Tuple2(
			'{snippet_Img.elm}',
			{code: '{{< highlight elm >}}img : \n    List (Attribute msg)\n    -> List (Html msg) \n    -> Html msg{{< /highlight >}}', gist: '79cae9a620e9301ac37891edef8f668a'}),
			_Utils_Tuple2(
			'{snippet_Image.elm}',
			{code: '{{< highlight elm >}}image :\n    List (Attribute msg)\n    -> { src : String, description : String }\n    -> Element msg{{< /highlight >}}', gist: 'f914b5221f0786ac33e6e0434e1cf25d'}),
			_Utils_Tuple2(
			'{snippet_separator_leading.css}',
			{code: '{{< highlight css >}}.parent\n    { height: 100%\n    ; display: flex\n    ; justify-content: center\n    ; align-items: center\n    }{{< /highlight >}}', gist: 'b4e1747c6adba97c0f32492bfb262baa'}),
			_Utils_Tuple2(
			'{snippet_}',
			{code: ' ', gist: ''}),
			_Utils_Tuple2(
...
var $author$project$Post$goToIndex = '\n\n[Index](#index) | [Top](#top)\n\n***\n\n';
